...
class MockKubernetesResponses:
    ...
    def get_deployment() -> Dict[str, Any]:
        ...
        return {
            "apiVersion": "apps/v1",
            "kind": "Deployment",
            "metadata": {"name": "llama-3-1-8b", "namespace": "llm-models"},
            "spec": {"replicas": 2},
        ...
        return [
            {
                ...
                "usage": {"cpu": "4000m", "memory": "32Gi", "nvidia.com/gpu": "2"},
            },
            {
                "metadata": {"name": "gpu-node-2"},
                "usage": {"cpu": "6000m", "memory": "48Gi", "nvidia.com/gpu": "4"},
            },
        ]
...
class MockCostServiceResponses:
    ...
    def hourly_costs() -> Dict[str, Any]:
        ...
        return {
            ...
            "costs": {
                "compute": {"gpu": 125.50, "cpu": 15.25, "memory": 8.75},
                "network": {"ingress": 2.50, "egress": 12.25},
                "storage": {"persistent": 5.00, "object": 3.25},
                "total": 172.50,
            },
            "resource_usage": {
                "gpu_hours": 32,

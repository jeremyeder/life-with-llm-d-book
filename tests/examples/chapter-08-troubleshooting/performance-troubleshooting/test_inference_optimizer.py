...
try:
    from chapter_08_troubleshooting.performance_troubleshooting.inference_optimizer import InferenceOptimizer
except ImportError:
    ...
    class InferenceOptimizer:
        ...
        def profile_inference(self, sample_inputs=None, num_iterations=10):
            ...
            if sample_inputs is None:
                sample_inputs = ["What is machine learning?", "Explain neural networks."]
        ...
        def apply_optimizations(self, optimizations=None):
            ...
            return {
                ...
                "success_rate": len([r for r in results.values() if r.get("applied", False)]) / len(optimizations)
            }
...
class TestInferenceOptimizer:
    ...
    def test_bottleneck_analysis(self, optimizer):
        ...
        expected_components = ["gpu_memory", "compute_utilization", "memory_bandwidth", "kernel_efficiency"]
        ...
        for component in expected_components:
            ...
            assert component_data["status"] in ["optimal", "good", "bottleneck", "critical"]
    ...
    def test_optimization_report_generation(self, optimizer):
        ...
        required_sections = [
            "model_info", "performance_summary", "applied_optimizations",
    ...
    def test_optimization_levels(self, optimization_level, tmp_path):
        ...
        model_path = str(tmp_path / "test_model")
        optimizer = InferenceOptimizer(model_path, optimization_level=optimization_level)
    ...
    def test_performance_regression_detection(self, optimizer):
        ...
        assert optimized["throughput_tokens_per_sec"] >= baseline["throughput_tokens_per_sec"]
        assert improvements["latency_improvement"] >= 0
        assert improvements["throughput_improvement"] >= 0

...
try:
    from chapter_10_mlops.kubeflow_pipelines.validate_model_config import validate_model_config, MODEL_CONFIG_SCHEMA
except ImportError:
...
class TestModelConfigValidation:
    ...
    def test_valid_basic_config(self):
        ...
        valid_config = {
            ...
            "source": {
                "type": "s3",
                "uri": "s3://model-registry/llama-3.1-7b/v1.0.0"
            }
        }
    ...
    def test_memory_gpu_ratio_validation(self):
        ...
        insufficient_memory_config = {
            ...
            "architecture": "transformer",
            "resources": {
                "memory_gb": 15,  # Only 7.5GB per GPU
                "gpu_count": 2
            }
        }
    ...
    def test_serving_configuration_validation(self):
        ...
        invalid_serving_configs = [
            {"max_batch_size": 0, "max_sequence_length": 2048, "protocol": "http"},  # Invalid batch size
            {"max_batch_size": 8, "max_sequence_length": 0, "protocol": "http"},    # Invalid sequence length
            {"max_batch_size": 8, "max_sequence_length": 2048, "protocol": "tcp"},  # Invalid protocol
        ]
    ...
    @pytest.mark.parametrize("gpu_count,memory_gb,expected_valid", [
    ...
    def test_name_format_validation(self):
        ...
        invalid_names = ["Llama-3.1-7B", "test_model", "test.model", "test@model", "TEST-MODEL"]

...
try:
    from chapter_04_data_scientist.performance_monitoring import PerformanceMonitor
except ImportError:
...
class TestPerformanceMonitoring:
    ...
    async def test_concurrent_metrics_collection(self, monitor):
        ...
        inference_metrics, gpu_metrics = await asyncio.gather(
            inference_task, gpu_task
        )

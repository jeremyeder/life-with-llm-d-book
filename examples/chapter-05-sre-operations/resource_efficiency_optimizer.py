class ResourceOptimizer:
    ...
    def _analyze_cpu_efficiency(self, cpu_data):
        ...
        return {
            ...
            "efficiency_score": min(
                avg_utilization / 0.7, 1.0
            ),  # Target 70% utilization
            "recommendation": self._cpu_recommendation(
    ...
    def _analyze_gpu_efficiency(self, gpu_data):
        ...
        return {
            ...
            "efficiency_score": min(
                avg_utilization / 0.8, 1.0
            ),  # Target 80% GPU utilization
            "recommendation": self._gpu_recommendation(
                avg_utilization, memory_utilization
            ),
        }
...
print(
    f"CPU Efficiency: {efficiency_report['current_efficiency']['cpu']['efficiency_score']:.2%}"
)
print(
    f"GPU Efficiency: {efficiency_report['current_efficiency']['gpu']['efficiency_score']:.2%}"
)
print(
    f"Potential Monthly Savings: ${efficiency_report['potential_savings']['monthly_usd']:.2f}"
)

class RetrainingPipeline:
    ...
    def should_retrain(self):
        ...
        retrain_conditions = [
            ...
            < self.training_config["min_quality_threshold"],
            current_metrics["drift_score"]
            > self.training_config["max_drift_threshold"],
            self._time_since_last_training()
            > self.training_config["max_training_interval"],
        ]
                        ...
                        "containers": [
                            {
                                ...
                                "env": [
                                    {
                                        "name": "MODEL_NAME",
                                        "value": self.model_config["name"],
                                    },
                                    {
                                        "name": "TRAINING_DATA",
                                        "value": self.training_config["data_source"],
                                    },
                                    {
                                        "name": "OUTPUT_PATH",
                                        "value": self.training_config["output_path"],
                                    },
                                ],
                                "resources": {
